...
export default class Initializer {
    ...
    public getCommandDisposables(): vscode.Disposable[] {
        ...
        const showPHPCSFixerVersionCommandDisposable: vscode.Disposable = vscode.commands.registerCommand(
            "phpthunder.showPHPCSFixerVersion",
            () => {
        ...
        const phpcsfixerDocumentCommandDisposable: vscode.Disposable = vscode.commands.registerCommand(
            "phpthunder.phpcsfixerDocument",
            () => {
    ...
    public getFormattersDisposables(): vscode.Disposable[] {
        ...
        if (this.plugin.getConfig().getFormatConfig().getPhpFormatter() === "php-cs-fixer") {
